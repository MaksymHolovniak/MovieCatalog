...
const Pagination: React.FC<PropsType> = ({ type }) => {
	...
	const sort = useSelector((state: AppStateType) => state.movies.sortUserMovies)
	const handlePageClick = (pageNumber: number) => {
		dispatch(getMoviesWithType(pageNumber, perPage, type, sort));
